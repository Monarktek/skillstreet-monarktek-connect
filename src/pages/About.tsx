        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              We've been developing NeighborMe for several years, with the idea starting about 10 years ago. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Meet the team behind NeighborMe. We've been working remotely together using Discord, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="group hover:shadow-glow transition-all duration-300 border-border">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Visionary leader who conceived the NeighborMe idea 10 years ago. Alan has been 
            ...
            <Card className="group hover:shadow-glow transition-all duration-300 border-border">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Full-stack developer who helped build NeighborMe from the ground up. 
          ...
          <div className="text-center mb-12">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-lg text-muted-foreground mb-6">
                The idea for NeighborMe began 10 years ago when our founder Alan Hourmand 
              ...
              <p className="text-lg text-muted-foreground mb-6">
                ...
                Working remotely and collaborating primarily through Discord, we've built NeighborMe 
                from the ground up with a focus on user experience and community impact.
              </p>
              <p className="text-lg text-muted-foreground">
                Today, NeighborMe represents years of dedication, innovation, and a deep commitment 
